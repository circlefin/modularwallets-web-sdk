...
import baseJestConfig, {
  createMonorepoCoverageReporters,
} from '@templates/jest/jest.config'
...
export default {
  ...
  coveragePathIgnorePatterns: ['./types', './*/index.ts', '/abis/'],

  coverageReporters: createMonorepoCoverageReporters(__dirname),
